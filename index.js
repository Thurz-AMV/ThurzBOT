const  XBOT = 'Thurz BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/62.thurz'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6289637186819'; // Nomor whatsapplu cok
const aktif = 'Tiap hari'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://www.youtube.com/channel/UCyxAqPwy4j0Y5TtL-Awa0tA'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289637186819:+62 896-3718-6819\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Thurz AMV`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Thurz AMV`)
})
